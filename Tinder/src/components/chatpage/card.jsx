            ...
            <div id="card">
                <div className="mx-auto my-auto">
                    ...
                    <div id="game-pad" className="d-flex justify-content-around  align-items-center">
                            <button onClick={this._handleNext} className="hvr-grow emotion" type="button"><i id="back" className="fa fa-chevron-left"></i></button>
                            <LikeButton handleLike={this._handleLike}/>
                            <CancelButton handleCancel={this._handleCancel} />
                            <button onClick={this._handleNext} className="hvr-grow emotion" type="button"><i id="next" className="fa fa-chevron-right"></i></button>
                    </div>
                </div>
